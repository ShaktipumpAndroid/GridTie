...
class MChartFullScreen extends StatefulWidget {
  bool isPlant;
  double maximumInterval = 50;
  late List<DevicePrefix.Response> deviceData = [];
  late List<PlantPrefix.Response> plantData = [];

  MChartFullScreen({Key? key, required this.isPlant, required this.maximumInterval, required this.deviceData , required this.plantData}) : super(key: key);

  @override
  State<MChartFullScreen> createState() => MChartFullScreenState();
}

class MChartFullScreenState extends State<MChartFullScreen> {
