...
class _ProfilePageState extends State<ProfilePage> {
  ...
  profileWidget() {
    return Container(
      margin: EdgeInsets.only(
          top: MediaQuery.of(context).size.height / 3.5, left: 20, right: 20),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          lineWidget(),
          detailWidget(
              about, aboutDesc, "assets/svg/aboutIcon.svg", aboutUSUrl),
          const SizedBox(
            height: 5,
          ),
          lineWidget(),
          detailWidget(privacyPolicy, privacyPolicyDesc,
              "assets/svg/privacyIcon.svg", privacyPolicyUrl),
          const SizedBox(
            height: 5,
          ),
          lineWidget(),
          detailWidget(termsConditions, termsConditionsDesc,
              "assets/svg/termsConditionsIcon.svg", termsConditionUrl),
          lineWidget(),
